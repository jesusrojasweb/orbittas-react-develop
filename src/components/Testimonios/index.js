...
export const Testimonios = ({idioma})=>{
  ...
  let testimonios = [
    {
      logo: 'https://firebasestorage.googleapis.com/v0/b/pagina-oribttas.appspot.com/o/files%2Fp4b.png?alt=media&token=5d04bcb3-44e0-4573-b358-72c7f1c763d9',
      testimonio: 'Orbittas, liderado por María Elizabeth, es una empresa que cuenta con el músculo y talento para sacar adelante proyectos complejos de tecnología. Nuestra red social de fútbol que va camino a romper barreras a nivel internacional es una realidad gracias a su arduo y profesional trabajo. Además son asequibles de forma tal que después de desarrollar la herramienta tecnológica solicitada prestan el servicio de mantenimiento, dando soluciones inmediatas a esas situaciones que siempre puede ocurrir! Por otro lado son de ética innegable lo cual genera confianza en ellos como personas y como aliados del negocio!',
      "testimonioEn": 'Orbittas, led by María Elizabeth, is a company that has the muscle and talent to carry out complex technology projects. Our football social network that is on its way to breaking down barriers internationally is a reality thanks to its hard and professional work. They are also affordable in such a way that after developing the requested technological tool they provide the maintenance service, giving immediate solutions to those situations that can always happen! On the other hand they are of undeniable ethics which generates trust in them as people and as business allies!',
      persona: 'Felipe Sandoval',
      cargo: 'Founder, P4B',
      personaProfile: ''
    },
    {
      logo: 'https://firebasestorage.googleapis.com/v0/b/pagina-oribttas.appspot.com/o/files%2Flogo-rmd.png?alt=media&token=9a08d427-322f-437d-883f-e807d852b7b1',
      testimonio: 'Orbittas es un gran equipo de ingenieros, profesionales, responsables y con una gran calidad humana. Dispuestos a resolver cada situación y cada reto de ingeniería con la mayor excelencia posible. ¡Esta gente es simplemente genial!',
      testimonioEn: 'Orbittas is a great engineering team, very professional, responsible and with great human quality. Willing to solve every situation and every engineering challenge with the greatest possible excellence. These people are simply amazing',
      persona: 'Raul Moreno',
      cargo: 'Founder of Design and Engineering',
      personaProfile: 'https://firebasestorage.googleapis.com/v0/b/pagina-oribttas.appspot.com/o/files%2Fraul-moreno.png?alt=media&token=884caa0b-cac2-4fb9-befb-12d7591d085c'
    }
  ]
